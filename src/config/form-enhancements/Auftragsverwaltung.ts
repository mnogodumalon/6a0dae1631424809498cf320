...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["auftragsnummer", "auftragsdatum", "status", "kunde", "mitarbeiter", "motiv", "druckbreite_cm", "druckhoehe_cm", "materialien", "wunschtermin", "lieferart", {"row": ["liefer_strasse", "liefer_hausnummer"], "cols": "2fr 1fr"}, {"row": ["liefer_plz", "liefer_ort"], "cols": "1fr 2fr"}, "sonderanforderungen", "interne_notizen"],
  defaults: {},
  computed: {},
};
